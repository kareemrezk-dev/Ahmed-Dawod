...
export function ProductCard({
  ...
  return (
    ...
    >
      {/* ── Image area ── */}
      <Link href={`/${locale}/products/${product.slug}`} className={styles.imageArea} prefetch={false} tabIndex={-1} aria-hidden="true" onClick={() => trackProductClick(product.slug, product.brand)}>
      ...
      <div className={styles.textArea}>
        ...
        <a href={waUrl} target="_blank" rel="noopener noreferrer" className={styles.waBtn} onClick={() => trackWhatsAppClick("product_card")}>
