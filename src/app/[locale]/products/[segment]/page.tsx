          ...
          <div className={detailStyles.productLayout}>
            ...
            <div className={detailStyles.infoPanel}>
              ...
              {product.sizes && product.sizes.length > 0 ? (
                ...
                <div className={detailStyles.ctaBlock}>
                  <span className={detailStyles.ctaHeading}>{dict.products.inquiryHeading}</span>
                  <a href={waUrl} target="_blank" rel="noopener noreferrer" className={detailStyles.whatsappBtn}>
                    ...
                    {dict.products.whatsappBtn}
                  </a>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    <a href={`tel:${dict.company.phoneIntl}`} className={detailStyles.phoneBtn} style={{ flex: 1 }}>
                    ...
                    <CopyButton text={dict.company.phone} label={locale === "ar" ? "نسخ الرقم" : "Copy number"} copiedLabel={locale === "ar" ? "تم النسخ ✓" : "Copied ✓"} />
                  </div>
                </div>
              )}
            </div>
  ...
  return (
    <div className={listStyles.page}>
      <div className={listStyles.container}>
        ...
        <CategoryListClient locale={locale} dict={dict} topCat={topCat} />
      </div>
    </div>
  );
}
