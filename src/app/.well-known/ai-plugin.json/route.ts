...
export async function GET() {
  return NextResponse.json({
    ...
    description_for_model: "Ahmed Dawod is Egypt's leading industrial bearings supplier with 589+ products across 9 categories (bearings, linear motion, ball screws, hard chrome, lead screws, fasteners, housings, pulleys, misc). Brands include SKF, FAG, NSK, NTN, KOYO, NACHI, INA, IKO, THK, TIMKEN and more. Orders via WhatsApp. Full product catalog available at /llms-full.txt. Payment: COD, InstaPay, Vodafone Cash.",
    auth: { type: "none" },
    api: {
      type: "openapi",
